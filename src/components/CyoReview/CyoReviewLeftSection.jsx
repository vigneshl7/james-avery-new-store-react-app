...
const CyoReviewLeftSection = ({ engravingData, engravingImage }) => {
  ...
  return (
    <div className="col-12 col-lg-6 product-detail-left-section ">
      <div className="engraving-image-container">
        <img
          src={imageUrl}
...
export default CyoReviewLeftSection;
