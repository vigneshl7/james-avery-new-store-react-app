...
const Model = ({ isModelOpen, setisModelOpen }) => {
  const { isOpen, type } = isModelOpen;
        ...
        <div className="modal-content">
          <div className="modal-header border-0">
            <button
              ...
              aria-label="Close"
              onClick={()=>setisModelOpen({...isModelOpen,isOpen:false})}
            ></button>
          </div>
          <div className="modal-body">
            ...
            <p className="font-14">
              {isLaser ? "Crisp, Clear, Easy-to-Read" : "Artistic, Reflective, One-of-a-Kind"}
            </p>
            ...
            <p className="m-0 font-12 text-padding">
              {isLaser ? (
                <>
                  Including Symbols & Punctuation<br />
